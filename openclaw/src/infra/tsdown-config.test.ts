  ...
  it("keeps core, plugin runtime, plugin-sdk, bundled plugins, and bundled hooks in one dist graph", () => {
    ...
    expect(entryKeys(distGraphs[0])).toEqual(
      expect.arrayContaining([
        ...
        "agents/openclaw-tools.runtime",
        "agents/pi-embedded.runtime",
        "agents/pi-model-discovery-runtime",
        "auto-reply/commands-registry.runtime",
        "auto-reply/reply.runtime",
        "auto-reply/skill-commands.runtime",
        "auto-reply/reply/agent-runner.runtime",
        "auto-reply/reply/commands-core.runtime",
